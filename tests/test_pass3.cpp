...
TEST_F(Pass3, SingleMatchAfterUnique)
{
    ...
    EXPECT_EQ(ifc.file_line[SECOND_FILE][2].ptr0, 2) << "File2 line 2 should point to file1 line 2";
}
...
TEST_F(Pass3, MultipleUniquePairsWithExtensions)
{
    ...
    EXPECT_EQ(ifc.file_line[FIRST_FILE][6].ptr_type, LineType::MATCH_TYPE)
...
TEST_F(Pass3, MixedPattern)
{
    ...
    EXPECT_EQ(ifc.file_line[FIRST_FILE][6].ptr_type, LineType::MATCH_TYPE);
    EXPECT_EQ(ifc.file_line[SECOND_FILE][6].ptr_type, LineType::MATCH_TYPE);
}
...
TEST_F(Pass3, BidirectionalLinking_Extension)
{
    ...
    EXPECT_EQ(ifc.file_line[SECOND_FILE][3].ptr0, 3)
